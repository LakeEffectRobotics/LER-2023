...
public class AutoLowCubeBackwardsCommand extends SequentialCommandGroup {
    private static final double CLAW_SPEED = 0.35;

    /**
     * @param arm
     * @param wrist
     */
    public AutoLowCubeBackwardsCommand(Arm arm, Wrist wrist, Claw claw) {
